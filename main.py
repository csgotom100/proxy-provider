...
def to_link(p):
    """生成通用订阅链接 (支持 SS, VLESS, VMess, Trojan, HY2)"""
    try:
        ...
        # 5. VMess
            ...
            v_conf = {
                "v":"2", "ps":p.get('name'), "add":srv, "port":prt, 
                "id":p.get('uuid'), "aid":"0", "net":"tcp", "type":"none", "tls":"tls"
            }
...
if __name__ == "__main__":
    ...
    print(f"INFO: 去重后总计 {len(unique_proxies)} 个节点，开始并发测速...")
    ...
    print(f"🎉 任务结束! 最终活节点: {len(final_nodes)}")
